  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child:GetBuilder<CartController>(builder: (controller)=>CustomBottomCartNavigationBar(
          apply: (){
            cartController.checkCoupon();
          },
          controllerCoupon: cartController.controllerCoupon!,
          price: '${cartController.priceOrders}', discount: '${controller.discountCoupon}%',Shipping: '500', totalPrice: '${controller.getTotalPrice()}',) ,),
      ),
