  ...
  Widget build(BuildContext context) {
    return   PageView.builder(
      ...
      children: [
        ...
        Text('${onBoardinList[i].title}',style:Theme.of(context).textTheme.displayLarge,),
        SizedBox(height: 80,),
        Image.asset('${onBoardinList[i].image}',width: 200,height: 230,fit: BoxFit.fill,),
        SizedBox(height: 80,),
        Container(alignment: Alignment.center,width: double.infinity,child: Text('${onBoardinList[i].body}',style: Theme.of(context).textTheme.bodyLarge)),
      ],
    ));
  }
}
