...
import 'package:shoppapp/paymob/widget/Paymentdetails.dart';
...
import 'package:shoppapp/veiw/chatbot/ChatBot.dart';
import 'package:shoppapp/veiw/chatbot/classification.dart';
...
import 'package:shoppapp/veiw/screens/OffersScreen.dart';
...
import 'package:shoppapp/veiw/screens/checkout.dart';
import 'package:shoppapp/veiw/screens/items.dart';
import 'package:shoppapp/veiw/screens/language.dart';
import 'package:shoppapp/veiw/screens/notificationView.dart';
import 'package:shoppapp/veiw/screens/orders/achive.dart';
import 'package:shoppapp/veiw/screens/orders/details.dart';
import 'package:shoppapp/veiw/screens/orders/pending.dart';
...
List<GetPage<dynamic>>routes=[
  ...
  //GetPage(name: '/', page: ()=> CartScreen()),
   ...
   GetPage(name: AppRoute.OffersItemsScreen, page: ()=>  OffersItemsScreen()),
   GetPage(name: AppRoute.PaymentDetails, page: ()=>  PaymentDetails()),
   GetPage(name: AppRoute.ChatScreen, page: ()=>  ChatScreen()),
   GetPage(name: AppRoute.classifcation, page: ()=>  HomeScreenClaas()),
