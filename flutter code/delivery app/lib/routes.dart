...
import 'package:shopadmin/veiw/chatbot/ChatBot.dart';
...
import 'package:shopadmin/veiw/screens/orders/trackingView.dart';
...
List<GetPage<dynamic>>routes=[
  ...
  //GetPage(name: '/', page: ()=> CartScreen()),
   ...
   GetPage(name: AppRoute.ChatScreen, page: ()=>  ChatScreen()),
      GetPage(name: AppRoute.ordersTracking, page: ()=>  OrdersTracking()),
