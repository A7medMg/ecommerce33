           ...
           // Text("Order Status:${controller.printOrdersStatus(listdata.ordersStatus!.toString())}",style: TextStyle(fontFamily: 'Cairo',fontSize: 15),),
            ...
            Row(
              children: [
               ...
               SizedBox(width: 10,),
            if(listdata.ordersStatus.toString()=="3")   MaterialButton(onPressed: (){
              //  controller.deleteOrders(listdata.ordersId.toString());


              controller.doneOrders(listdata.ordersUsersid.toString(),listdata.ordersId.toString());
                },child: Text("Done"),color:Colorapp.secondColor,textColor: Colors.white,)
              ],
            ),
