...
class EditeCategoriesAdmin extends StatelessWidget {
  const EditeCategoriesAdmin({super.key});

  @override
  Widget build(BuildContext context) {
    CategoriesAdminEditController controller=Get.put(CategoriesAdminEditController());
    return Scaffold(
      appBar: AppBar(
        title: Text("Edite Categories"),
      ),
      body: GetBuilder<CategoriesAdminEditController>(builder: (controller)=>HandlingDataView(statusRequest: controller.statusRequest, widget: Container(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 15,),
              CustomBottomAuth(text: "Edite",onPressed: (){
                controller.editData();
              },),
